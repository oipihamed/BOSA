...
class ProductoDAO {
    ...
    getAllProducts() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield database_1.default.then((connection) => __awaiter(this, void 0, void 0, function* () {
                    return yield connection.query("Select idProducto,tp.nombre,tp.descripcion,cantidadExistencia,precio,estatusOferta,cc.nombre as nombreCategoria,tp.idCategoria,(select rutaImagen from cimagen c where c.idProducto=tp.idProducto LIMIT 1) as rutaImagen from tproducto tp INNER JOIN ccategoria cc on tp.idCategoria=cc.idCategoria");
                }));
                return result;
            }
            catch (err) {
    ...
    getAllImgPro(idProducto) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield database_1.default.then((connection) => __awaiter(this, void 0, void 0, function* () {
                    return yield connection.query(`SELECT rutaImagen FROM cimagen WHERE idProducto=? LIMIT 3`, [idProducto]);
                }));
                return result;
            }
            catch (err) {
